...
import androidx.paging.PagedList.Config.Builder as PagedListBuilder

class MoveeRepository private constructor(private val remoteDataSource: RemoteDataSource, private val localDataSource: LocalDataSource, private val appExecutors: AppExecutors) : MoveeDataSource {
    ...
    companion object {
        @Volatile
        private var moveeRepository: MoveeRepository? = null

        fun getRepository(remoteDataSource: RemoteDataSource, localDataSource: LocalDataSource, appExecutors: AppExecutors): MoveeRepository {
            return moveeRepository ?: synchronized(this) {
                MoveeRepository(remoteDataSource, localDataSource, appExecutors).apply {
                    moveeRepository = this
                }
            }
        }
    }
